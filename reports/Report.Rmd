...
Comparing 2 cycles i want to see the trend of new learners. From the below table i see that i have fewer learners in the 5th run.
...
**Leaving course**  
Comparing the learners leaving from the course i see that more people are leaving in 5th run. This gives an alert message to the FutureLearn to take action by abalyzing the reason of leaving.
...
Leaving Reason is a useful feedback, because it gives you  an assessment from the learners about the course. It would be an indication of enrich the contemnt of activities or change the topic in some cases.
