...
**Analysis of the FuturLearn course **
...
## Business Undertanding
 The main business objective of the analysis was to uncover important  factors and to reveal indicators that will keep the enrollments in growth rate. Seminars must always  be interesting from all the learners.Part of the analysis , some strategic plans may needed for the sustainability of the company.   
...
**Leaving Reason File**
This kind of information is important becuase it gives a feedback of people who leaving the course. Their opinion is always countable.
...
**Joining many Files**
By merging  many sets of files   information’s about the trend of enrollments by year/month and the average duration of the course can be extracted. The history of the data files help us to have more precise results in some analysis.    

This graphs gives us the trend of enrollment. it is important for the course to see if people are interested in attending the course in order to take actions.
...
## Modeling 
By applying model fitting in some variables, we can extract useful informations. These informations may related with the trend of new enrollments as well the quality of the seminars. This kind of information can help to uncover hideden informations and take some important actions for the good of the FutureLearn.  
...
Analysis 0f **leaving  reason** from some learners, will rethink some strategies plans of the FutureLearn.  
